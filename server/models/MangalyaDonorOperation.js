...
const mangalyaDonorOperationSchema = new mongoose.Schema(
  {
    ...
    qrEligibilityOverride: { type: Boolean, default: false },
    qrEligibilityOverrideReason: { type: String, default: '', trim: true },
    qrEligibilityOverrideAt: { type: Date, default: null },
    qrEligibilityOverrideBy: { type: String, default: '' },
