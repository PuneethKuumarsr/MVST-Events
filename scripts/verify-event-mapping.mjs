...
assert.ok(backend.includes('updateAuthUserRecord(currentUser.id, { pin: newPassword })'), 'Change password must store the new password through the existing hash mechanism');
